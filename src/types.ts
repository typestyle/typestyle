...
export interface CSSProperties {
  ...
  '-apple-trailing-word'?: string;
  '-epub-caption-side'?: string;
  '-epub-hyphens'?: string;
  '-epub-text-combine'?: string;
  '-epub-text-emphasis'?: string;
  '-epub-text-emphasis-color'?: string;
  '-epub-text-emphasis-style'?: string;
  '-epub-text-orientation'?: string;
  '-epub-text-transform'?: string;
  '-epub-word-break'?: string;
  '-epub-writing-mode'?: string;
  '-internal-marquee-direction'?: string;
  '-internal-marquee-increment'?: string;
  '-internal-marquee-repetition'?: string;
  '-internal-marquee-speed'?: string;
  '-internal-marquee-style'?: string;
  ...
  '-moz-columns'?: string;
  '-moz-control-character-visibility'?: string;
  ...
  '-moz-math-display'?: string;
  '-moz-math-variant'?: string;
  '-moz-min-font-size-ratio'?: string;
  '-moz-orient'?: string;
  ...
  '-moz-script-level'?: string;
  '-moz-script-min-size'?: string;
  '-moz-script-size-multiplier'?: string;
  ...
  '-ms-animation'?: string;
  '-ms-animation-delay'?: string;
  '-ms-animation-direction'?: string;
  '-ms-animation-duration'?: string;
  '-ms-animation-fill-mode'?: string;
  '-ms-animation-iteration-count'?: string;
  '-ms-animation-name'?: string;
  '-ms-animation-play-state'?: string;
  '-ms-animation-timing-function'?: string;
  '-ms-backface-visibility'?: string;
  '-ms-background-position-x'?: string;
  '-ms-background-position-y'?: string;
  '-ms-behavior'?: string;
  ...
  '-ms-ime-align'?: string;
  '-ms-ime-mode'?: string;
  '-ms-interpolation-mode'?: string;
  '-ms-layout-flow'?: string;
  '-ms-layout-grid'?: string;
  '-ms-layout-grid-char'?: string;
  '-ms-layout-grid-line'?: string;
  '-ms-layout-grid-mode'?: string;
  '-ms-layout-grid-type'?: string;
  ...
  '-webkit-animation-trigger'?: string;
  ...
  '-webkit-column-progression'?: string;
  ...
  '-webkit-cursor-visibility'?: string;
  '-webkit-dashboard-region'?: string;
  ...
  '-webkit-grid'?: string;
  '-webkit-grid-area'?: string;
  '-webkit-grid-auto-columns'?: string;
  '-webkit-grid-auto-flow'?: string;
  '-webkit-grid-auto-rows'?: string;
  '-webkit-grid-column'?: string;
  '-webkit-grid-column-end'?: string;
  '-webkit-grid-column-gap'?: string;
  '-webkit-grid-column-start'?: string;
  '-webkit-grid-gap'?: string;
  '-webkit-grid-row'?: string;
  '-webkit-grid-row-end'?: string;
  '-webkit-grid-row-gap'?: string;
  '-webkit-grid-row-start'?: string;
  '-webkit-grid-template'?: string;
  '-webkit-grid-template-areas'?: string;
  '-webkit-grid-template-columns'?: string;
  '-webkit-grid-template-rows'?: string;
  ...
  '-webkit-initial-letter'?: string;
  '-webkit-justify-items'?: string;
  '-webkit-justify-self'?: string;
  ...
  '-webkit-mask-source-type'?: string;
  ...
  '-webkit-region-fragment'?: string;
  '-webkit-rtl-ordering'?: string;
  '-webkit-ruby-position'?: string;
  '-webkit-scroll-snap-coordinate'?: string;
  '-webkit-scroll-snap-destination'?: string;
  ...
  '-webkit-shape-outside'?: string;
  '-webkit-svg-shadow'?: string;
  '-webkit-tap-highlight-color'?: string;
  '-webkit-text-align-last'?: string;

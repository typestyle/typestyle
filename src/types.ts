...
export interface CSSProperties {
  ...
  '-apple-trailing-word'?: any;
  '-epub-caption-side'?: any;
  '-epub-hyphens'?: any;
  '-epub-text-combine'?: any;
  '-epub-text-emphasis'?: any;
  '-epub-text-emphasis-color'?: any;
  '-epub-text-emphasis-style'?: any;
  '-epub-text-orientation'?: any;
  '-epub-text-transform'?: any;
  '-epub-word-break'?: any;
  '-epub-writing-mode'?: any;
  '-internal-marquee-direction'?: any;
  '-internal-marquee-increment'?: any;
  '-internal-marquee-repetition'?: any;
  '-internal-marquee-speed'?: any;
  '-internal-marquee-style'?: any;
  '-moz-appearance'?: any;
  '-moz-binding'?: any;
  '-moz-border-bottom-colors'?: any;
  '-moz-border-end'?: any;
  '-moz-border-end-color'?: any;
  '-moz-border-end-style'?: any;
  '-moz-border-end-width'?: any;
  '-moz-border-left-colors'?: any;
  '-moz-border-right-colors'?: any;
  '-moz-border-start'?: any;
  '-moz-border-start-color'?: any;
  '-moz-border-start-style'?: any;
  '-moz-border-start-width'?: any;
  '-moz-border-top-colors'?: any;
  '-moz-box-align'?: any;
  '-moz-box-direction'?: any;
  '-moz-box-flex'?: any;
  '-moz-box-ordinal-group'?: any;
  '-moz-box-orient'?: any;
  '-moz-box-pack'?: any;
  '-moz-column-count'?: any;
  '-moz-column-fill'?: any;
  '-moz-column-gap'?: any;
  '-moz-column-rule'?: any;
  '-moz-column-rule-color'?: any;
  '-moz-column-rule-style'?: any;
  '-moz-column-rule-width'?: any;
  '-moz-column-width'?: any;
  '-moz-columns'?: any;
  '-moz-control-character-visibility'?: any;
  '-moz-float-edge'?: any;
  '-moz-force-broken-image-icon'?: any;
  '-moz-hyphens'?: any;
  '-moz-image-region'?: any;
  '-moz-margin-end'?: any;
  '-moz-margin-start'?: any;
  '-moz-math-display'?: any;
  '-moz-math-variant'?: any;
  '-moz-min-font-size-ratio'?: any;
  '-moz-orient'?: any;
  '-moz-osx-font-smoothing'?: any;
  '-moz-outline-radius'?: any;
  '-moz-outline-radius-bottomleft'?: any;
  '-moz-outline-radius-bottomright'?: any;
  '-moz-outline-radius-topleft'?: any;
  '-moz-outline-radius-topright'?: any;
  '-moz-padding-end'?: any;
  '-moz-padding-start'?: any;
  '-moz-script-level'?: any;
  '-moz-script-min-size'?: any;
  '-moz-script-size-multiplier'?: any;
  '-moz-stack-sizing'?: any;
  '-moz-tab-size'?: any;
  '-moz-text-align-last'?: any;
  '-moz-text-decoration-color'?: any;
  '-moz-text-decoration-line'?: any;
  '-moz-text-decoration-style'?: any;
  '-moz-text-size-adjust'?: any;
  '-moz-top-layer'?: any;
  '-moz-transform'?: any;
  '-moz-user-focus'?: any;
  '-moz-user-input'?: any;
  '-moz-user-modify'?: any;
  '-moz-window-dragging'?: any;
  '-moz-window-shadow'?: any;
  '-ms-accelerator'?: any;
  '-ms-animation'?: any;
  '-ms-animation-delay'?: any;
  '-ms-animation-direction'?: any;
  '-ms-animation-duration'?: any;
  '-ms-animation-fill-mode'?: any;
  '-ms-animation-iteration-count'?: any;
  '-ms-animation-name'?: any;
  '-ms-animation-play-state'?: any;
  '-ms-animation-timing-function'?: any;
  '-ms-backface-visibility'?: any;
  '-ms-background-position-x'?: any;
  '-ms-background-position-y'?: any;
  '-ms-behavior'?: any;
  '-ms-block-progression'?: any;
  '-ms-content-zoom-chaining'?: any;
  '-ms-content-zoom-limit'?: any;
  '-ms-content-zoom-limit-max'?: any;
  '-ms-content-zoom-limit-min'?: any;
  '-ms-content-zoom-snap'?: any;
  '-ms-content-zoom-snap-points'?: any;
  '-ms-content-zoom-snap-type'?: any;
  '-ms-content-zooming'?: any;
  '-ms-filter'?: any;
  '-ms-flex-flow'?: any;
  '-ms-flex-line-pack'?: any;
  '-ms-flex-order'?: any;
  '-ms-flex-preferred-size'?: any;
  '-ms-flow-from'?: any;
  '-ms-flow-into'?: any;
  '-ms-font-feature-settings'?: any;
  '-ms-grid-column'?: any;
  '-ms-grid-column-align'?: any;
  '-ms-grid-column-span'?: any;
  '-ms-grid-columns'?: any;
  '-ms-grid-row'?: any;
  '-ms-grid-row-align'?: any;
  '-ms-grid-row-span'?: any;
  '-ms-grid-rows'?: any;
  '-ms-high-contrast-adjust'?: any;
  '-ms-hyphenate-limit-chars'?: any;
  '-ms-hyphenate-limit-lines'?: any;
  '-ms-hyphenate-limit-zone'?: any;
  '-ms-hyphens'?: any;
  '-ms-ime-align'?: any;
  '-ms-ime-mode'?: any;
  '-ms-interpolation-mode'?: any;
  '-ms-layout-flow'?: any;
  '-ms-layout-grid'?: any;
  '-ms-layout-grid-char'?: any;
  '-ms-layout-grid-line'?: any;
  '-ms-layout-grid-mode'?: any;
  '-ms-layout-grid-type'?: any;
  '-ms-line-break'?: any;
  '-ms-overflow-style'?: any;
  '-ms-overflow-x'?: any;
  '-ms-overflow-y'?: any;
  '-ms-perspective'?: any;
  '-ms-perspective-origin'?: any;
  '-ms-perspective-origin-x'?: any;
  '-ms-perspective-origin-y'?: any;
  '-ms-scroll-chaining'?: any;
  '-ms-scroll-limit'?: any;
  ...
  '-ms-scroll-rails'?: any;
  '-ms-scroll-snap-points-x'?: any;
  '-ms-scroll-snap-points-y'?: any;
  '-ms-scroll-snap-type'?: any;
  '-ms-scroll-snap-x'?: any;
  '-ms-scroll-snap-y'?: any;
  '-ms-scroll-translation'?: any;
  '-ms-scrollbar-3dlight-color'?: any;
  '-ms-scrollbar-arrow-color'?: any;
  '-ms-scrollbar-base-color'?: any;
  '-ms-scrollbar-darkshadow-color'?: any;
  '-ms-scrollbar-face-color'?: any;
  '-ms-scrollbar-highlight-color'?: any;
  '-ms-scrollbar-shadow-color'?: any;
  '-ms-scrollbar-track-color'?: any;
  '-ms-text-align-last'?: any;
  '-ms-text-autospace'?: any;
  '-ms-text-combine-horizontal'?: any;
  '-ms-text-justify'?: any;
  '-ms-text-kashida-space'?: any;
  '-ms-text-overflow'?: any;
  '-ms-text-size-adjust'?: any;
  '-ms-text-underline-position'?: any;
  '-ms-touch-action'?: any;
  '-ms-touch-select'?: any;
  '-ms-transform'?: any;
  '-ms-transform-origin'?: any;
  '-ms-transform-origin-x'?: any;
  '-ms-transform-origin-y'?: any;
  '-ms-transform-origin-z'?: any;
  '-ms-transform-style'?: any;
  '-ms-transition'?: any;
  '-ms-transition-delay'?: any;
  '-ms-transition-duration'?: any;
  '-ms-transition-property'?: any;
  '-ms-transition-timing-function'?: any;
  '-ms-word-break'?: any;
  '-ms-word-wrap'?: any;
  '-ms-wrap-flow'?: any;
  '-ms-wrap-margin'?: any;
  ...
  '-ms-writing-mode'?: any;
  '-ms-zoom'?: any;
  '-webkit-align-content'?: any;
  '-webkit-alt'?: any;
  '-webkit-animation'?: any;
  '-webkit-animation-delay'?: any;
  '-webkit-animation-direction'?: any;
  '-webkit-animation-duration'?: any;
  '-webkit-animation-fill-mode'?: any;
  '-webkit-animation-iteration-count'?: any;
  '-webkit-animation-name'?: any;
  '-webkit-animation-play-state'?: any;
  '-webkit-animation-timing-function'?: any;
  '-webkit-animation-trigger'?: any;
  '-webkit-app-region'?: any;
  '-webkit-appearance'?: any;
  '-webkit-aspect-ratio'?: any;
  '-webkit-backdrop-filter'?: any;
  '-webkit-backface-visibility'?: any;
  '-webkit-background-clip'?: any;
  '-webkit-background-composite'?: any;
  '-webkit-background-origin'?: any;
  '-webkit-background-size'?: any;
  '-webkit-border-after'?: any;
  '-webkit-border-after-color'?: any;
  '-webkit-border-after-style'?: any;
  '-webkit-border-after-width'?: any;
  '-webkit-border-before'?: any;
  '-webkit-border-before-color'?: any;
  '-webkit-border-before-style'?: any;
  '-webkit-border-before-width'?: any;
  '-webkit-border-bottom-left-radius'?: any;
  '-webkit-border-bottom-right-radius'?: any;
  '-webkit-border-end'?: any;
  '-webkit-border-end-color'?: any;
  '-webkit-border-end-style'?: any;
  '-webkit-border-end-width'?: any;
  '-webkit-border-fit'?: any;
  '-webkit-border-horizontal-spacing'?: any;
  '-webkit-border-image'?: any;
  '-webkit-border-radius'?: any;
  '-webkit-border-start'?: any;
  '-webkit-border-start-color'?: any;
  '-webkit-border-start-style'?: any;
  '-webkit-border-start-width'?: any;
  '-webkit-border-top-left-radius'?: any;
  '-webkit-border-top-right-radius'?: any;
  '-webkit-border-vertical-spacing'?: any;
  '-webkit-box-align'?: any;
  '-webkit-box-decoration-break'?: any;
  '-webkit-box-direction'?: any;
  '-webkit-box-flex'?: any;
  '-webkit-box-flex-group'?: any;
  '-webkit-box-lines'?: any;
  '-webkit-box-ordinal-group'?: any;
  '-webkit-box-orient'?: any;
  '-webkit-box-pack'?: any;
  '-webkit-box-reflect'?: any;
  '-webkit-box-shadow'?: any;
  '-webkit-clip-path'?: any;
  '-webkit-color-correction'?: any;
  '-webkit-column-axis'?: any;
  '-webkit-column-break-after'?: any;
  '-webkit-column-break-before'?: any;
  '-webkit-column-break-inside'?: any;
  '-webkit-column-count'?: any;
  '-webkit-column-fill'?: any;
  '-webkit-column-gap'?: any;
  '-webkit-column-progression'?: any;
  '-webkit-column-rule'?: any;
  '-webkit-column-rule-color'?: any;
  '-webkit-column-rule-style'?: any;
  '-webkit-column-rule-width'?: any;
  '-webkit-column-span'?: any;
  '-webkit-column-width'?: any;
  '-webkit-columns'?: any;
  '-webkit-cursor-visibility'?: any;
  '-webkit-dashboard-region'?: any;
  '-webkit-filter'?: any;
  '-webkit-flex-basis'?: any;
  '-webkit-flex-flow'?: any;
  '-webkit-flow-from'?: any;
  '-webkit-flow-into'?: any;
  '-webkit-font-feature-settings'?: any;
  '-webkit-font-kerning'?: any;
  '-webkit-font-size-delta'?: any;
  '-webkit-font-smoothing'?: any;
  '-webkit-font-variant-ligatures'?: any;
  '-webkit-grid'?: any;
  '-webkit-grid-area'?: any;
  '-webkit-grid-auto-columns'?: any;
  '-webkit-grid-auto-flow'?: any;
  '-webkit-grid-auto-rows'?: any;
  '-webkit-grid-column'?: any;
  '-webkit-grid-column-end'?: any;
  '-webkit-grid-column-gap'?: any;
  '-webkit-grid-column-start'?: any;
  '-webkit-grid-gap'?: any;
  '-webkit-grid-row'?: any;
  '-webkit-grid-row-end'?: any;
  '-webkit-grid-row-gap'?: any;
  '-webkit-grid-row-start'?: any;
  '-webkit-grid-template'?: any;
  '-webkit-grid-template-areas'?: any;
  '-webkit-grid-template-columns'?: any;
  '-webkit-grid-template-rows'?: any;
  '-webkit-highlight'?: any;
  '-webkit-hyphenate-character'?: any;
  '-webkit-hyphenate-limit-after'?: any;
  '-webkit-hyphenate-limit-before'?: any;
  '-webkit-hyphenate-limit-lines'?: any;
  '-webkit-hyphens'?: any;
  '-webkit-initial-letter'?: any;
  '-webkit-justify-items'?: any;
  '-webkit-justify-self'?: any;
  '-webkit-line-align'?: any;
  '-webkit-line-box-contain'?: any;
  '-webkit-line-break'?: any;
  '-webkit-line-clamp'?: any;
  '-webkit-line-grid'?: any;
  '-webkit-line-snap'?: any;
  '-webkit-locale'?: any;
  '-webkit-logical-height'?: any;
  '-webkit-logical-width'?: any;
  '-webkit-margin-after'?: any;
  '-webkit-margin-after-collapse'?: any;
  '-webkit-margin-before'?: any;
  '-webkit-margin-before-collapse'?: any;
  '-webkit-margin-bottom-collapse'?: any;
  '-webkit-margin-collapse'?: any;
  '-webkit-margin-end'?: any;
  '-webkit-margin-start'?: any;
  '-webkit-margin-top-collapse'?: any;
  '-webkit-marquee'?: any;
  '-webkit-marquee-direction'?: any;
  '-webkit-marquee-increment'?: any;
  '-webkit-marquee-repetition'?: any;
  '-webkit-marquee-speed'?: any;
  '-webkit-marquee-style'?: any;
  '-webkit-mask'?: any;
  '-webkit-mask-box-image'?: any;
  '-webkit-mask-box-image-outset'?: any;
  '-webkit-mask-box-image-repeat'?: any;
  '-webkit-mask-box-image-slice'?: any;
  '-webkit-mask-box-image-source'?: any;
  '-webkit-mask-box-image-width'?: any;
  '-webkit-mask-clip'?: any;
  '-webkit-mask-composite'?: any;
  '-webkit-mask-image'?: any;
  '-webkit-mask-origin'?: any;
  '-webkit-mask-position'?: any;
  '-webkit-mask-position-x'?: any;
  '-webkit-mask-position-y'?: any;
  '-webkit-mask-repeat'?: any;
  '-webkit-mask-repeat-x'?: any;
  '-webkit-mask-repeat-y'?: any;
  '-webkit-mask-size'?: any;
  '-webkit-mask-source-type'?: any;
  '-webkit-max-logical-height'?: any;
  '-webkit-max-logical-width'?: any;
  '-webkit-min-logical-height'?: any;
  '-webkit-min-logical-width'?: any;
  '-webkit-nbsp-mode'?: any;
  '-webkit-opacity'?: any;
  '-webkit-order'?: any;
  '-webkit-padding-after'?: any;
  '-webkit-padding-before'?: any;
  '-webkit-padding-end'?: any;
  '-webkit-padding-start'?: any;
  '-webkit-perspective'?: any;
  '-webkit-perspective-origin'?: any;
  '-webkit-perspective-origin-x'?: any;
  '-webkit-perspective-origin-y'?: any;
  '-webkit-print-color-adjust'?: any;
  '-webkit-region-break-after'?: any;
  '-webkit-region-break-before'?: any;
  '-webkit-region-break-inside'?: any;
  '-webkit-region-fragment'?: any;
  '-webkit-rtl-ordering'?: any;
  '-webkit-ruby-position'?: any;
  '-webkit-scroll-snap-coordinate'?: any;
  '-webkit-scroll-snap-destination'?: any;
  '-webkit-scroll-snap-points-x'?: any;
  '-webkit-scroll-snap-points-y'?: any;
  '-webkit-scroll-snap-type'?: any;
  '-webkit-shape-image-threshold'?: any;
  '-webkit-shape-margin'?: any;
  '-webkit-shape-outside'?: any;
  '-webkit-svg-shadow'?: any;
  '-webkit-tap-highlight-color'?: any;
  '-webkit-text-align-last'?: any;
  '-webkit-text-combine'?: any;
  '-webkit-text-decoration'?: any;
  '-webkit-text-decoration-color'?: any;
  '-webkit-text-decoration-line'?: any;
  '-webkit-text-decoration-skip'?: any;
  '-webkit-text-decoration-style'?: any;
  '-webkit-text-decorations-in-effect'?: any;
  '-webkit-text-emphasis'?: any;
  '-webkit-text-emphasis-color'?: any;
  '-webkit-text-emphasis-position'?: any;
  '-webkit-text-emphasis-style'?: any;
  '-webkit-text-fill-color'?: any;
  '-webkit-text-justify'?: any;
  '-webkit-text-orientation'?: any;
  '-webkit-text-security'?: any;
  '-webkit-text-size-adjust'?: any;
  '-webkit-text-stroke'?: any;
  '-webkit-text-stroke-color'?: any;
  '-webkit-text-stroke-width'?: any;
  '-webkit-text-underline-position'?: any;
  '-webkit-text-zoom'?: any;
  '-webkit-touch-callout'?: any;
  '-webkit-transform'?: any;
  '-webkit-transform-origin'?: any;
  '-webkit-transform-origin-x'?: any;
  '-webkit-transform-origin-y'?: any;
  '-webkit-transform-origin-z'?: any;
  '-webkit-transform-style'?: any;
  '-webkit-transition'?: any;
  '-webkit-transition-delay'?: any;
  '-webkit-transition-duration'?: any;
  '-webkit-transition-property'?: any;
  '-webkit-transition-timing-function'?: any;
  '-webkit-user-drag'?: any;
  '-webkit-user-modify'?: any;
  '-webkit-writing-mode'?: any;
}
